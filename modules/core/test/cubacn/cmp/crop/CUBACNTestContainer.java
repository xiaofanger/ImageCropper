...
public class CUBACNTestContainer extends TestContainer {

    public CUBACNTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "cubacn/cmp/crop/app.properties",
                "cubacn/cmp/crop/app-test.properties",
    ...
    public static class Common extends CUBACNTestContainer {

        public static final CUBACNTestContainer.Common INSTANCE = new CUBACNTestContainer.Common();
