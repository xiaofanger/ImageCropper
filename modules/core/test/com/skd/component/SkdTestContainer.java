...
public class SkdTestContainer extends TestContainer {

    public SkdTestContainer() {
        super();
    ...
    public static class Common extends SkdTestContainer {

        public static final SkdTestContainer.Common INSTANCE = new SkdTestContainer.Common();
